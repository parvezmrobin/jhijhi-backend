...
const {
  startUp, tearDown, testBasicDataIntegrity,
} = require('./_helpers');
...
describe('Test Match Functionality', function matchTestSuit() {
  ...
  function testMatch1DataIntegrity(afterToss, innings) {
    return testBasicDataIntegrity(matchId1, token1, afterToss, innings);
  }
